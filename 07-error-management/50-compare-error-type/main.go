...
func GetTransactionAmountHandler1(w http.ResponseWriter, r *http.Request) {
...
func getTransactionAmountFromDB2(id string) (float32, error) {
	var err error
	if err != nil {
		return 0, transientError{err: err}
	}
...
func GetTransactionAmountHandler2(w http.ResponseWriter, r *http.Request) {
	transactionID := r.URL.Query().Get("transaction")
